...
dataset_old = pd.read_csv("apparitions_august_2022.csv", encoding="utf-8")



dataset_july = pd.read_csv("august_2022.csv", encoding="utf-8")

dataset = pd.concat([dataset_july,])
...
df = pd.date_range(start='1/1/2016', end='31/12/2022')
...
dataset_all.to_csv("apparitions_august_2022.csv", encoding="utf-8", index=False)
