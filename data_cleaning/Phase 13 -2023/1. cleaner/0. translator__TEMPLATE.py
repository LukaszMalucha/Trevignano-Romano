...
#dataset["text_it"] = np.where(((dataset["month"] == XXX) & (dataset["day"] == 3)), "", dataset["text_it"])


# ENGLISH

#dataset["text_en"] = np.where(((dataset["month"] == XXX) & (dataset["day"] == 3)), "", dataset["text_en"])


# POLISH

#dataset["text_pl"] = np.where(((dataset["month"] == XXX) & (dataset["day"] == 3)), "", dataset["text_pl"])
