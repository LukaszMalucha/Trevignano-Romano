...
dataset2021 = pd.concat([dataset_jan, dataset_feb, dataset_mar, dataset_apr, dataset_may, dataset_june, dataset_july, dataset_august, dataset_september, dataset_october, dataset_november])
